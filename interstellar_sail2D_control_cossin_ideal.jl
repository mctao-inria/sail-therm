...
p1 = plot(sol.times .* TU / 86400 / 365, [ x_sol[i][1] for i ∈ 1:Nsol ], size=(600, 300), linewidth = 1, color = "blue", xlabel = "t", ylabel = "r₁")
p2 = plot(sol.times .* TU / 86400 / 365, [ x_sol[i][2] for i ∈ 1:Nsol ], size=(600, 300), linewidth = 1, color = "blue", xlabel = "t", ylabel = "r₂")
p3 = plot(sol.times .* TU / 86400 / 365, [ x_sol[i][3] for i ∈ 1:Nsol ], size=(600, 300), linewidth = 1, color = "blue", xlabel = "t", ylabel = "v₁")
...
plot_normr = Plots.plot(sol.times .* TU / 86400 / 365, normr, size=(600, 600), label="distance from the Sun", linewidth = 2, color = "blue")
plot!(matrix_data[1] .* TU / 86400 / 365, sqrt.(matrix_data[2].^2 + matrix_data[3].^2), label="distance from the Sun, local-optimal", linewidth = 1, color = "red")
